...
- **Webhooks**: HTTP callbacks for server-to-server email notifications
...
<Tabs>
	<TabItem label="Gradle">
		<pre>
			<code class="language-groovy">{`implementation 'com.vaultsandbox:client:${versions.java}'`}</code>
		</pre>
	</TabItem>
	<TabItem label="Maven">
		<pre>
...
- [Chaos Engineering](/client-java/guides/chaos/) - Test email resilience with simulated failures
